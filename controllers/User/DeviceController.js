                    ...
                    if(devList.status === 0){
                        ...
                        Block.findOne({
                            ...
                            if(myBlock){
                                ...
                                else if(devList.device_type == 10){
                                        ...
                                        Device.update(
                                          {
                                            device_link_imei: myReq.device_link_imei,
                                            data: mydata,
                                            settings:{grid_charge_enable: 33667},
                                            flags:{is_grid_charge: 0},
                                            block_id: myBlock.id
                                          },
                                          {
                                            where:{
        ...
        Auth.Merchant(req.headers.token).then(myMerchant=>{
             ...
             Device.findOne({
                where:{
                 ...
                 var myTime = `${myDateTime.getHours()}:${myDateTime.getMinutes() + 1}:${myDateTime.getSeconds()}`;
                 var startKookTime = `${myDate} ${myTime}`;
                 Device.update(
                    {
             ...
             Device.findOne({
                where:{
                 ...
                 Device.update(
                    ...
                    res.status(200).send({
                        success:true,
                        message: 'Successfully calcelled',
                        data:[]
                    });
                ...
                Device.findOne({
                    ...
                    raw: true
                     ...
                     if(myDevice){
                        ...
                        if(typeof myDeviceFlags === 'string'){
                ...
                Device.findOne({
                    ...
                    raw: true
                     ...
                     if(myDevice){
                        ...
                        var newData = {...myDeviceData,output: 1,control:0,disabled:0};
